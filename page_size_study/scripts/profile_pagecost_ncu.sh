...
# Run as: ssh phastform 'echo PW | sudo -S -E CACHE=all bash ~/sglang_log/profile_pagecost_ncu.sh'
# Never writes the sudo password anywhere; logs each privileged action to SUDO_CHANGES.md.
set -u
