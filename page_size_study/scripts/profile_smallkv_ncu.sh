...
OUTDIR=${OUTDIR:-$TARGET_HOME/sglang_log/offline_batch_results/smallkv_profile}
SUDO_LOG=${SUDO_LOG:-$TARGET_HOME/sglang_log/page_size_study/report_8_smallkv_truebatch/SUDO_CHANGES.md}
WARMUP=${WARMUP:-8}
CACHE=${CACHE:-all}
