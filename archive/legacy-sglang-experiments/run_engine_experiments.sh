...
#
# Usage:
#   ./run_engine_experiments.sh              # default: tpot mode
#   ./run_engine_experiments.sh profile       # accurate per-op timing (sync all)  -> studies/kv-cache-page-size/data/raw/profile_sync/
#   ./run_engine_experiments.sh profile-raw   # raw CUDA events (no sync, fast)    -> studies/kv-cache-page-size/data/raw/profile_raw/
#   ./run_engine_experiments.sh tpot          # no profiling, cleanest TPOT         -> studies/kv-cache-page-size/data/raw/tpot/
#   ./run_engine_experiments.sh tpot-no-share         # no profiling, no prefix sharing              -> studies/kv-cache-page-size/data/raw/tpot_no_share/
#   ./run_engine_experiments.sh tpot-no-share-page16  # no profiling, no prefix sharing, page_size=16 -> studies/kv-cache-page-size/data/raw/tpot_no_share_page16/
#   ./run_engine_experiments.sh profile-no-share # profiling, no prefix sharing    -> studies/kv-cache-page-size/data/raw/profile_sync_no_share/
#   ./run_engine_experiments.sh nsys                # nsys GPU profiling (SM%, DRAM BW, with sharing)    -> studies/kv-cache-page-size/data/raw/nsys/
#   ./run_engine_experiments.sh nsys-tpot-no-share  # nsys GPU profiling (no KV sharing)                 -> studies/kv-cache-page-size/data/raw/nsys_no_share/
#   ./run_engine_experiments.sh ncu                 # ncu kernel profiling: exact DRAM bytes/step (with KV sharing)   -> studies/kv-cache-page-size/data/raw/ncu/
#   ./run_engine_experiments.sh ncu-no-share        # ncu kernel profiling: exact DRAM bytes/step (no KV sharing)     -> studies/kv-cache-page-size/data/raw/ncu_no_share/
#   ./run_engine_experiments.sh page-size-sweep          # sweep page_size=1..128, no prefix sharing (default token=4096)  -> studies/kv-cache-page-size/data/raw/page_size_sweep/
#   ./run_engine_experiments.sh nsys-page-size-sweep     # nsys kernel timeline per page size (bs=1, 256 tokens default)   -> studies/kv-cache-page-size/data/raw/nsys_page_size_sweep/
#   ./run_engine_experiments.sh page-size-sweep 256 4096 8192  # same but with multiple token sizes
#   ./run_engine_experiments.sh page-size-sweep-bs            # sweep page_size across batch sizes (attention-bound regime — finds where page_size=1 is NOT lowest)  -> studies/kv-cache-page-size/data/raw/page_size_sweep_bs/
#   ./run_engine_experiments.sh page-size-sweep-bs 8184       # same, longest decode (longest KV) only
...
case "$MODE" in
    profile)
        ...
        OUTPUT_DIR="studies/kv-cache-page-size/data/raw/profile_sync"
    ...
    profile-raw)
        ...
        export TREE_SPARSE_TIMING_INTERVAL=10
        OUTPUT_DIR="studies/kv-cache-page-size/data/raw/profile_raw"
    ...
    tpot)
        ...
        unset TREE_SPARSE_TIMING_SYNC_OPS
        OUTPUT_DIR="studies/kv-cache-page-size/data/raw/tpot"
    ...
    tpot-no-share)
        ...
        unset TREE_SPARSE_TIMING_SYNC_ALL
        unset TREE_SPARSE_TIMING_SYNC_OPS
        OUTPUT_DIR="studies/kv-cache-page-size/data/raw/tpot_no_share"
    ...
    tpot-no-share-page16)
        ...
        unset TREE_SPARSE_TIMING_SYNC_ALL
        unset TREE_SPARSE_TIMING_SYNC_OPS
        OUTPUT_DIR="studies/kv-cache-page-size/data/raw/tpot_no_share_page16"
    ...
    profile-no-share)
        ...
        export TREE_SPARSE_TIMING_SYNC_ALL=1
        export TREE_SPARSE_TIMING_INTERVAL=10
        OUTPUT_DIR="studies/kv-cache-page-size/data/raw/profile_sync_no_share"
    ...
    nsys)
        ...
        unset TREE_SPARSE_TIMING_SYNC_ALL
        unset TREE_SPARSE_TIMING_SYNC_OPS
        OUTPUT_DIR="studies/kv-cache-page-size/data/raw/nsys"
    ...
    nsys-tpot-no-share)
        ...
        unset TREE_SPARSE_TIMING_SYNC_ALL
        unset TREE_SPARSE_TIMING_SYNC_OPS
        OUTPUT_DIR="studies/kv-cache-page-size/data/raw/nsys_no_share"
    ...
    ncu)
        ...
        unset TREE_SPARSE_TIMING_SYNC_ALL
        unset TREE_SPARSE_TIMING_SYNC_OPS
        OUTPUT_DIR="studies/kv-cache-page-size/data/raw/ncu"
    ...
    ncu-no-share)
        ...
        unset TREE_SPARSE_TIMING_SYNC_ALL
        unset TREE_SPARSE_TIMING_SYNC_OPS
        OUTPUT_DIR="studies/kv-cache-page-size/data/raw/ncu_no_share"
    ...
    nsys-page-size-sweep)
        ...
        unset TREE_SPARSE_TIMING_SYNC_ALL
        unset TREE_SPARSE_TIMING_SYNC_OPS
        OUTPUT_DIR="studies/kv-cache-page-size/data/raw/nsys_page_size_sweep"
    ...
    page-size-sweep)
        ...
        unset TREE_SPARSE_TIMING_SYNC_ALL
        unset TREE_SPARSE_TIMING_SYNC_OPS
        OUTPUT_DIR="studies/kv-cache-page-size/data/raw/page_size_sweep"
    ...
    page-size-sweep-bs)
        ...
        unset TREE_SPARSE_TIMING_SYNC_ALL
        unset TREE_SPARSE_TIMING_SYNC_OPS
        OUTPUT_DIR="studies/kv-cache-page-size/data/raw/page_size_sweep_bs"
...
PYEOF
        ...
        ANALYZE_SCRIPT="$(dirname "$0")/studies/kv-cache-page-size/data/raw/nsys_page_size_sweep/analyze_nsys.py"
