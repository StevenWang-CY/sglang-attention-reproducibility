...
#        CELLS="2 1024|1 512" PAGES="1 128" \
#        bash <checkout>/studies/kv-cache-page-size/scripts/profile_offwall_ncu.sh'
# Never writes the sudo password; logs every privileged action to provenance.md.
set -u
...
OUTDIR=${OUTDIR:-$STUDY_ROOT/data/raw/offwall_profile}
SUDO_LOG=${SUDO_LOG:-$STUDY_ROOT/reports/13-true-batch-off-wall/provenance.md}
WARMUP=8
CACHE=${CACHE:-all}
