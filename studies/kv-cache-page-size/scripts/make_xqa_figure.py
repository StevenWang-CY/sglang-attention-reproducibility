...
fig_xqa_tma.png      — from ncu CSVs (studies/kv-cache-page-size/data/raw/xqa_profile/), drawn
...
ROOT = HERE.parents[3]
OUT = HERE.parents[1] / "reports" / "06-xqa-tma-profile"
LAT_JSON = ROOT / "studies" / "kv-cache-page-size" / "data" / "raw" / "xqa_profile_5060ti" / "xqa_latency.json"
NCU_DIR = ROOT / "studies" / "kv-cache-page-size" / "data" / "raw" / "xqa_profile"
...
def fig_tma():
    ...
    # Panel B: global-load instructions vs page_size (XQA page-dependent, FI flat)
    axB = axes[1]
    for be in ("xqa", "flashinfer"):
    ...
    axB.set_title("(B) XQA global loads are page-dependent\nFlashInfer is approximately flat")
