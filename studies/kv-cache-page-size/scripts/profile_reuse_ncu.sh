...
#        CELLS="1 1024|4 1024|8 1024" PAGES=128 \
#        bash <checkout>/studies/kv-cache-page-size/scripts/profile_reuse_ncu.sh'
...
OUTDIR=${OUTDIR:-$STUDY_ROOT/data/raw/reuse_profile}
