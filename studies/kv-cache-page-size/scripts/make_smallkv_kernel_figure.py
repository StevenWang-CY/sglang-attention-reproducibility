...
Reads:
  studies/kv-cache-page-size/data/raw/smallkv_profile/lat_distinct_b{1,8,32}.json        (CUDA-event latency)
  studies/kv-cache-page-size/data/raw/smallkv_profile/flashinfer_distinct_{all,none}_ps{ps}_bs{B}_kv{L}.csv  (ncu)
Writes ../08-small-kv-true-batch/fig_smallkv_kernel.png:
...
D = ROOT / "studies" / "kv-cache-page-size" / "data" / "raw" / "smallkv_profile"
OUT = Path(__file__).resolve().parents[1] / "reports" / "08-small-kv-true-batch"
