...
Reads studies/kv-cache-page-size/data/raw/offwall_profile/ (ncu CSVs + latency/pagecost JSONs)
and studies/kv-cache-page-size/data/raw/bench_one_batch_offwall_5060ti/ (engine JSONLs), prints:
...
Run from anywhere:  python3 studies/kv-cache-page-size/scripts/analyze_offwall.py
"""
...
DBOB = ROOT / "studies" / "kv-cache-page-size" / "data" / "raw" / "bench_one_batch_offwall_5060ti"
HEAD_DIM = 128
