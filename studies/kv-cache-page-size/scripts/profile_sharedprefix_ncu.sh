...
#   attention kernel, SHARED vs DISTINCT KV, to compare the L2-reuse and
#   DRAM-streaming regimes characterized in Report 7.
#
...
# Within each: page_size {1,128}. Cells include bs8x39k — reachable in BOTH modes
#   here because the microbench has no model
...
OUTDIR=${OUTDIR:-$STUDY_ROOT/data/raw/sharedprefix_profile}
SUDO_LOG=${SUDO_LOG:-$STUDY_ROOT/reports/07-shared-prefix-mechanism/provenance.md}
WARMUP=${WARMUP:-5}
